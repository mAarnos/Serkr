...
mod test {
    ...
    #[test]
    fn pelletier_20() {
        let result = resolution("((forall x. forall y. exists z. forall w. ((P(x) /\\ Q(y)) ==> (R(z) /\\ S(w))))
    ...
    #[test]
    fn pelletier_27() {
        let result = resolution("(((((exists x. (F(x) /\\ ~G(x))) /\\ 
                                     (forall x. (F(x) ==> H(x)))) /\\ 
   ...
   fn pelletier_31() {
    ...
    #[test]
    fn pelletier_32() {
        let result = resolution("(((forall x. ((F(x) /\\ (G(x) \\/ H(x))) ==> I(x))) /\\ 
    ...
    #[test]
    fn pelletier_38() {
        let result = resolution("((forall x. ((P(a()) /\\ (P(x) ==> exists y. (P(y) /\\ R(x, y)))) ==> exists z. exists w. (P(z) /\\ (R(x, w) /\\ R(w, z))))) <=>
    ...
    */
    ...
    #[test]
    fn los() {
        let result = resolution("(((((forall x. forall y. forall z. ((P(x, y) /\\ P(y, z)) ==> P(x, z))) /\\
