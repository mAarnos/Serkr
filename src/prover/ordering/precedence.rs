...
impl Precedence {
    ...
    pub fn gt(&self, s: &Term, t: &Term) -> bool {
        ...
        match *self {
            ...
            Precedence::ArityFrequency(ref frequency_table) => {
                arity_frequency_gt(frequency_table, s, t)
            }
...
/// Orders function symbols first based on arity and then based on a frequency table.
